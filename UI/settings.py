...
class Settings(Frame):
    ...
    def list_qs(self, package_id):
        ...
        self.canvas = Canvas(self.subFrame, width = 1000, height = 430, scrollregion=(0, 0, 500, 200))
        ...
        self.canvas.grid(row=2, column=2, columnspan=5)
...
#J Go back to package menu
    ...
    def create_q_form(self, new_row, frame="x"):
        if frame == "x":
            frame = self.subFrame
        self.b_add.destroy()
